            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST"
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Category Uzbek</label>
                            <input type="text" class="form-control" name="subcategory_uz"
                                   value="{{$subcategory->subcategory_uz}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id" id="exampleFormControlSelect2">
                                ...
                                @foreach($category as $row)
                                    ...
                                    >{{$row->category_en}} | {{$row->category_uz}}</option>
                                @endforeach
                            </select>
                        </div>

            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('store.subcategory')}}">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">SubCategory Uzbek</label>
                            <input type="text" class="form-control" name="subcategory_uz" placeholder="Category Uzbek">
                            @error('subcategory_uz')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id" id="exampleFormControlSelect2">
                                ...
                                @foreach($category as $row)
                                    <option value="{{$row->id}}">{{$row->category_en}} | {{$row->category_uz}}</option>
                                @endforeach
                            </select>
                        </div>

                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($subcategory as $row)
                                <tr>
                                    ...
                                    <td> {{$row->subcategory_uz}} </td>
                                    <td> {{$row->category_en}} </td>
                                    <td>
                                        <a href="{{route('edit.subcategory',$row->id)}}" class="btn btn-info">Edit</a>
                                        <a href="{{route('delete.subcategory',$row->id)}}" class="btn btn-danger"
                                           onclick="return confirm('Are sure to delete')">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
